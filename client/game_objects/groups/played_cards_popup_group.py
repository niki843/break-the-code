...
from client.game_objects.tiles.height_resizable_multiline_text_tile import (
...
class PlayedCardsPopupGroup:
    ...
    def add_played_card(self, played_card_tile: Tile, player_responses: dict):
        ...
        for name, response in player_responses.items():
            player_response_tile = HeightResizableMultilineTextTile(
    ...
    def scroll_elements(self, scroll_pixels):
        for played_card, player_responses in self.played_cards_and_player_responses:
            played_card.rect.top += scroll_pixels
            for player_response in player_responses:
                player_response.rect.top += scroll_pixels
                player_response.center_text()
